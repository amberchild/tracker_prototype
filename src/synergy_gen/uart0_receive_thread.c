...
TX_THREAD uart0_receive_thread;
void uart0_receive_thread_create(void);
static void uart0_receive_thread_func(ULONG thread_input);
static uint8_t uart0_receive_thread_stack[1024] BSP_PLACE_IN_SECTION_V2(".stack.uart0_receive_thread") BSP_ALIGN_VARIABLE_V2(BSP_STACK_ALIGNMENT);
...
#define g_sf_modem_uart0_err_callback_WEAK_ATTRIBUTE
#pragma weak g_sf_modem_uart0_err_callback  = g_sf_modem_uart0_err_callback_internal
#elif defined(__GNUC__)
#define g_sf_modem_uart0_err_callback_WEAK_ATTRIBUTE   __attribute__ ((weak, alias("g_sf_modem_uart0_err_callback_internal")))
#endif
void g_sf_modem_uart0_err_callback(void *p_instance, void *p_data)
g_sf_modem_uart0_err_callback_WEAK_ATTRIBUTE;
static sf_uart_comms_instance_ctrl_t g_sf_modem_uart0_ctrl;
static const sf_uart_comms_cfg_t g_sf_modem_uart0_cfg_extend =
{ .p_lower_lvl_uart = &g_uart0, };
static const sf_comms_cfg_t g_sf_modem_uart0_cfg =
{ .p_extend = &g_sf_modem_uart0_cfg_extend, };
/* Instance structure to use this module. */
const sf_comms_instance_t g_sf_modem_uart0 =
{ .p_ctrl = &g_sf_modem_uart0_ctrl, .p_cfg = &g_sf_modem_uart0_cfg, .p_api = &g_sf_comms_on_sf_uart_comms };
/*******************************************************************************************************************//**
 ...
 **********************************************************************************************************************/
void g_sf_modem_uart0_err_callback_internal(void *p_instance, void *p_data);
void g_sf_modem_uart0_err_callback_internal(void *p_instance, void *p_data)
{
...
void g_sf_modem_uart0_init(void)
{
    ssp_err_t ssp_err_g_sf_modem_uart0;
    ssp_err_g_sf_modem_uart0 = g_sf_modem_uart0.p_api->open (g_sf_modem_uart0.p_ctrl, g_sf_modem_uart0.p_cfg);
    if (SSP_SUCCESS != ssp_err_g_sf_modem_uart0)
    {
        g_sf_modem_uart0_err_callback ((void *) &g_sf_modem_uart0, &ssp_err_g_sf_modem_uart0);
    }
}
...
#if (1)
    g_sf_modem_uart0_init ();
#endif

    /* Enter user code for this thread. */
    uart0_receive_thread_entry ();
}
